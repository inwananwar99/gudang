...
<?php foreach($kategori as $k1): ?>
        <!-- Modal Ubah Supplier -->
        <div class="modal fade" id="editModal<?= $k1['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Supplier/ubahSupplier/'.$k1['id']);?>" method="POST">
                <div class="form-group">
                    <label for="">Nama Supplier</label>
                    <input type="text" class="form-control" value="<?= $k1['nama']?>" name="nama">
                </div>
                <div class="form-group">
                    <label for="">Alamat Supplier</label>
                    <input type="text" class="form-control" value="<?= $k1['alamat']?>" name="alamat">
                </div>
                <div class="form-group">
                    <label for="">No. Handphone Supplier</label>
                    <input type="text" class="form-control" value="<?= $k1['no_hp']?>" name="no_hp">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
